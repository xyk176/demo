  ...
  <div id="sangpinadd">
    ...
    <div class="tanchuang_box">
     ...
     <el-dialog title="关联单品" id="addpro_dialog" width="65%" :visible.sync="tanchuang.isxuanzepro" :close-on-click-modal="false" top="20px">
      ...
      <!-- 属性新增弹窗 -->
      <el-dialog title="收货地址" :visible.sync="tanchuang.iscpyadd">
        <el-form ref="add_cpy" :model="add_cpy.add_cpy" label-width="80px">
          <el-form-item label="属性名称">
            <el-input v-model="add_cpy.add_cpy.cpyname"></el-input>
          </el-form-item>
        </el-form>
